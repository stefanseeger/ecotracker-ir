...
- Multiple sensors:
  ...
  - Energy In (kWh)
  - Energy Out (kWh)
  - Daily Energy Import (resets daily)
  - Daily Energy Export (resets daily)
  - Monthly Energy Import (resets monthly)
  - Monthly Energy Export (resets monthly)
  - Yearly Energy Import (resets yearly)
  - Yearly Energy Export (resets yearly)
...
- `sensor.ecotracker_daily_energy_in` - Daily energy imported in Watt-hours (resets at midnight)
- `sensor.ecotracker_daily_energy_out` - Daily energy exported in Watt-hours (resets at midnight)
- `sensor.ecotracker_monthly_energy_in` - Monthly energy imported in Watt-hours (resets on first day of month)
- `sensor.ecotracker_monthly_energy_out` - Monthly energy exported in Watt-hours (resets on first day of month)
- `sensor.ecotracker_yearly_energy_in` - Yearly energy imported in Watt-hours (resets on January 1st)
- `sensor.ecotracker_yearly_energy_out` - Yearly energy exported in Watt-hours (resets on January 1st)
